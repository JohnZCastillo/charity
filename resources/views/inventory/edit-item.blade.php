        ...
        <div class="p-2 row mx-0">
            ...
            <form enctype="multipart/form-data" class="form col-sm-12 col-md-6" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input value="{{$item->code}}" name="code" type="text" class="form-control"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input value="{{$item->stock}}" name="stock" type="number" class="form-control"/>
                </div>

                <div class="d-flex gap-2 align-items-center mt-2">
                    <button type="submit" class="btn btn-primary">Update</button>
                    <a href="/items" type="button" class="btn btn-secondary">Back</a>
                </div>
